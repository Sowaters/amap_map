...
class CircleUpdates {
  ...
  CircleUpdates.from(Set<Circle> previous, Set<Circle> current) {
    ...
    final Set<String> tempCircleIdsToRemove =
        prevCircleIds.difference(currentCircleIds);

    final Set<Circle> tempCirclesToAdd = currentCircleIds
    ...
    final Set<Circle> tempCirclesToChange = currentCircleIds
        .intersection(prevCircleIds)
        .map(idToCurrentCircle)
        .where(hasChanged)
        .toSet();

    circlesToAdd = tempCirclesToAdd;
    circleIdsToRemove = tempCircleIdsToRemove;
    circlesToChange = tempCirclesToChange;
  }
  ...
  int get hashCode => Object.hashAll(
      <Object?>[circlesToAdd, circleIdsToRemove, circlesToChange]);
